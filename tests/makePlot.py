...
if __name__=='__main__':
    ...
    plt.plot(testTime, testValue, 'b-', label='Coooling valve control signal, modeled', lw=1)
    plt.plot(refTime, refValue, 'r-', label='Cooling valve control signal, trended', lw=1)
